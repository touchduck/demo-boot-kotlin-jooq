...
public class UsersDao extends DAOImpl<UsersRecord, com.example.demo.infra.hawaii.tables.pojos.Users, UUID> {
     ...
     */
    public List<com.example.demo.infra.hawaii.tables.pojos.Users> fetchRangeOfBirthday(LocalDate lowerInclusive, LocalDate upperInclusive) {
        return fetchRange(Users.USERS.BIRTHDAY, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>birthday IN (values)</code>
     */
    public List<com.example.demo.infra.hawaii.tables.pojos.Users> fetchByBirthday(LocalDate... values) {
     ...
     */
    public List<com.example.demo.infra.hawaii.tables.pojos.Users> fetchRangeOfSex(Short lowerInclusive, Short upperInclusive) {
     ...
     */
    public List<com.example.demo.infra.hawaii.tables.pojos.Users> fetchBySex(Short... values) {
